...
function gradedrange(sectors_lengths::AbstractVector{<:Pair{<:Any,<:Integer}}; isdual=false)
  sectors = first.(sectors_lengths)
  lengths = last.(sectors_lengths)
  return gradedrange(Flux.(sectors, isdual) .=> lengths)
end
